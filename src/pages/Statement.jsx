  ...
  return (
    <div className='page'>
      ...
      <p className="text-block">
        ...
        All the blender models were painstakingly created by me, and the code was written from scratch, with reference to documentation and tutorials I used. I have cited any external resources used in the <a className="link" href="/references">References</a> section of this project.
      </p>
    </div>
  );
}
