  ...
  return (
    <div className="page">
      ...
      <p className="text-block">
        ...
        <br /><br />
        All the Blender models were painstakingly created by me, and the code was written from scratch using my own implementation. While I drew some structural inspirations from a similar 3D gallery project (referenced in the <a className="link" href="/references">References</a> section), all the code was written independently to suit the specific needs of this project. I have cited any external resources and tutorials I referenced in the <a className="link" href="/references">References</a> section of this project.
      </p>
    </div>
  );
}
