...
const CarouselControls = ({ onPrev, onNext }) => {
  ...
  const togglePlayPause = () => {
    if (isPaused) {
      ...
      // Mark as manual pause so incidental interactions do not auto-resume playback.
  ...
  // Split bars into left/right groups to frame the centered play/pause button.
  ...
  return (
    <div className="carousel-controls">
      ...
      <button className="carousel-playpause" onClick={togglePlayPause}>
